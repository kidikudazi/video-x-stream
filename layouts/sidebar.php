   <?php include ('__factory/fetch_menu_details.php'); ?>   
   <ul class="sidebar navbar-nav">
     ...
     <!--  <li class="nav-item">
      ...
      <li class="nav-item channel-sidebar-list">
         <h6>SUBSCRIPTIONS</h6>
         <ul>
            <?php foreach($subs as $list){ ?>
               <li>
                  <a href="single-channel.php?ch=<?php echo $list['channel_tag']; ?>">
                  <img class="img-fluid" alt="" src="<?php echo $list['profile_picture'] ?>"> <?php echo $list['channel_name']; ?>
                  </a>
               </li>
            <?php } ?>
            <?php if(count($subs) > 3){ ?>
